var app = (function () {
    ...
    const message = writable(localStorage.getItem("message") || `Un tattoo con esas características estaría {{mercadopago}} si abonás con MercadoPago (permite pagar en cuotas, te recomiendo consultar en https://www.mercadopago.com.ar/ayuda/medios-de-pago-cuotas-promociones_264 qué promociones o recargos aplican para tu tarjeta y tu banco); o en efectivo / transferencia se aplicaría un descuento y quedaría en {{efectivo}}`);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text(/*copyButtonText*/ ctx[0]);
    			t6 = space();
    			p1 = element("p");
    			t7 = text(/*parsedValue*/ ctx[1]);
    			attr_dev(p0, "class", "status svelte-15j18vn");
    			add_location(p0, file$2, 66, 2, 1950);
    			attr_dev(textarea, "class", "svelte-15j18vn");
    			add_location(textarea, file$2, 67, 2, 1983);
    			add_location(h2, file$2, 69, 4, 2066);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "svelte-15j18vn");
    			add_location(button, file$2, 70, 4, 2092);
    			attr_dev(div0, "class", "row svelte-15j18vn");
    			add_location(div0, file$2, 68, 2, 2044);
    			add_location(p1, file$2, 72, 2, 2167);
    			add_location(div1, file$2, 65, 0, 1942);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(textarea, "input", /*throttledSave*/ ctx[5], false, false, false),
    					listen_dev(button, "click", /*copy*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*status*/ 4) set_data_dev(t0, /*status*/ ctx[2]);

    			if (dirty & /*$message*/ 8) {
    				set_input_value(textarea, /*$message*/ ctx[3]);
    			}

    			if (dirty & /*copyButtonText*/ 1) set_data_dev(t5, /*copyButtonText*/ ctx[0]);
    			if (dirty & /*parsedValue*/ 2) set_data_dev(t7, /*parsedValue*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, calculations, $$value => $$invalidate(9, $calculations = $$value));
    	...
    	const copy = async () => {
    		...
    		$$invalidate(0, copyButtonText = "Copiado! ✨");
    		setTimeout(() => $$invalidate(0, copyButtonText = "Copiar"), 3000);
    	};
    	...
    	const throttledSave = e => {
    		...
    		throttling = setTimeout(
    			() => {
    				...
    				$$invalidate(2, status = "Guardado!");
    				if (changingMessage) clearTimeout(changingMessage);
    				changingMessage = setTimeout(() => $$invalidate(2, status = initialStauts), 2000);
    			},
    			250
    		);
    	};
    	...
    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Message> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("copyButtonText" in $$props) $$invalidate(0, copyButtonText = $$props.copyButtonText);
    		if ("parsedValue" in $$props) $$invalidate(1, parsedValue = $$props.parsedValue);
    		if ("status" in $$props) $$invalidate(2, status = $$props.status);
    		if ("throttling" in $$props) throttling = $$props.throttling;
    		if ("changingMessage" in $$props) changingMessage = $$props.changingMessage;
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$message, $calculations*/ 520) {
